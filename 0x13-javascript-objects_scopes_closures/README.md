...
> This directory shows examples of how to use Javascript with regards to: objects, classes, super, extends, prototypes, inheritance, and closures.
...
* 101 - imports dictionary from another file and recreates dic based on unique values
* 102 - script concatenates given files 
